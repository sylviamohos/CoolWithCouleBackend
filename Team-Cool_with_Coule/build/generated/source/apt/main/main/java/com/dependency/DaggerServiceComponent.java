...
public final class DaggerServiceComponent implements ServiceComponent {
  ...
  public POSTCheckoutActivity providePOSTCheckoutActivity() {
    return new POSTCheckoutActivity(getOrderDao(), getCustomerDao(), getProductDao());
  }
  ...
  @Override
  public GETProductByNameActivity provideGETProductByNameActivity() {
    return new GETProductByNameActivity(getProductDao());
  }

  @Override
  public GETProductsActivity provideGETProductsActivity() {
    return new GETProductsActivity(getProductDao());
  }
