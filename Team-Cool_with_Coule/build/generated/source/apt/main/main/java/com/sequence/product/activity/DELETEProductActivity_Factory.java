...
public final class DELETEProductActivity_Factory implements Factory<DELETEProductActivity> {
  ...
  public DELETEProductActivity_Factory(Provider<ProductDao> daoProvider) {
  ...
  public static DELETEProductActivity_Factory create(Provider<ProductDao> daoProvider) {
